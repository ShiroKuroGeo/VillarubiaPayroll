                ...
                <div class="modal-body">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-money">
                                ...
                                <input v-model.number="salaryForm.allowances" type="number" min="0" step="0.01"
                                    class="form-control" placeholder="0.00" />
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-money">
                                ...
                                <input v-model.number="salaryForm.deductions" type="number" min="0" step="0.01"
                                    class="form-control" placeholder="0.00" />
                    ...
                    <div class="salary-preview">
                        ...
                        <div class="preview-equation">
                            ...
                            {{ formatCurrency(Number(salaryForm.allowances) || 0) }}
...
const totalAllowances = computed(() => {
    ...
    return salaryData.value
        ...
        .reduce(
            (total, employee) =>
                total + Number(employee.allowances || 0),
            0
        )
...
const formNetSalary = computed(() => {
    ...
    return (
        ...
        Number(salaryForm.value.allowances || 0) -
    ...
    if (editingSalary.value) {
        ...
        if (index !== -1) {
            ...
            salaryData.value[index] = {
                ...
                allowances:
                    Number(salaryForm.value.allowances),
