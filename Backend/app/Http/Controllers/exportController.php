...
class exportController
{
    ...
    protected function writePayslipBlock($sheet, array $p): void
    {
        ...
        $sheet->setCellValue("E{$this->currentRow}", $this->payPeriod ?: '-');
        ...
        $sheet->setCellValue("A{$this->currentRow}", 'Department:');
        $sheet->setCellValue("B{$this->currentRow}", $p['department'] ?? '');
        ...
        $earningRows = [
            ...
            'Total Attendance (days)' => $earnings['total_attendance'] ?? 0,
        ];
